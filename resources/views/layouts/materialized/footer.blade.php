...
<!--prism
<script type="text/javascript" src="/materialized/js/prism/prism.js"></script>-->
<!--scrollbar-->
<script type="text/javascript" src="/materialized/js/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
<!-- chartist -->
<!-- <script type="text/javascript" src="/materialized/js/plugins/chartist-js/chartist.min.js"></script>    -->
