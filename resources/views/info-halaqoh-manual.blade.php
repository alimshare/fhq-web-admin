...
<head>
    ...
    <meta name="description" content="Daftar Halaqoh dan Peserta Forum Halaqoh Qur'an Semester 30">
    <meta name="keywords" content="fhq, forum halaqoh qur'an, mrbj, masjid raya bintaro jaya, halaqoh, fhq_annashr, tahsin, tahfidz">
    <title>Daftar Halaqoh & Peserta Semester 30 | FHQ </title>
                            ...
                            <table id="daftarHalaqoh" class="cell-border" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <tr class="row-filter">
                                        ...
                                        <th><input type="text" placeholder="SearchProgram Program" id="paramProgram" class="input-text"></th>
                                        <th>
                                            <select id="paramKbm">
                                                <option value=""></option>
