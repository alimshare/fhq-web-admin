        ...
        <div class="card-group">
          <div class="card p-4">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('login') }}">
              ...
              <p style="color: red">@if (Session::has('message')){{ session('message') }}@endif</p>
              ...
              <div class="input-group mb-4">
                ...
                <input id="password" type="password" class="form-control" name="password" required placeholder="Password" value="p@ssw0rd">
              </div>
